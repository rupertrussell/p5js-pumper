...
itemLocation[57] = ' Tool Bag - Offside 2';
...
itemName[61] = 'Crescent Wrench';
itemPicture[61] = 'crescentWrench.jpg';
itemLocation[61] = ' Tool Bag - Offside 2';
itemPictureLocation[61] = 'toolBagLocation.jpg';

itemName[62] = 'Duct Tape';
itemPicture[62] = 'ductTape.jpg';
itemLocation[62] = ' Tool Bag - Offside 2';
itemPictureLocation[62] = 'toolBagLocation.jpg';

itemName[63] = 'Yellow Thread Sealing Tape';
itemPicture[63] = 'yellowThreadSealingTape.jpg';
itemLocation[63] = ' Tool Bag - Offside 2';
itemPictureLocation[63] = 'toolBagLocation.jpg';

itemName[64] = 'Safety Bungee Hook';
itemPicture[64] = 'strap.jpg';
itemLocation[64] = ' Tool Bag - Offside 2';
itemPictureLocation[64] = 'toolBagLocation.jpg';

itemName[65] = 'Cable Ties (Fluro Pink 188mm)';
itemPicture[65] = 'pinkCableTies.jpg';
itemLocation[65] = ' Tool Bag - Offside 2';
itemPictureLocation[65] = 'toolBagLocation.jpg';

itemName[66] = 'Electrical Insulation Tape';
itemPicture[66] = 'electricalInsulationTape.jpg';
itemLocation[66] = ' Tool Bag & MVA Bag - Offside 2';
itemPictureLocation[66] = 'toolBagLocation.jpg';

itemName[67] = 'Nylon Hammer';
itemPicture[67] = 'nylonHammer.jpg';
itemLocation[67] = ' MVA Bag - Offside 2';
itemPictureLocation[67] = 'mvaBagLocation.jpg';

itemName[68] = 'Spanner set Roll';
itemPicture[68] = 'redTools.jpg';
itemLocation[68] = ' MVA Bag - Offside 2';
itemPictureLocation[68] = 'mvaBagLocation.jpg';

itemName[69] = 'MVA Tools';
itemPicture[69] = 'mvaTools.jpg';
itemLocation[69] = ' MVA Bag - Offside 2';
itemPictureLocation[69] = 'mvaBagLocation.jpg';

itemName[70] = '3 x Bi-Carb of Soda';
itemPicture[70] = 'Bi-CarbSoda.jpg';
itemLocation[70] = ' MVA Bag - Offside 2';
itemPictureLocation[70] = 'mvaBagLocation.jpg';

itemName[71] = 'Glass Breaker and Seatbelt Cutter';
itemPicture[71] = 'seatBeltCutter.jpg';
itemLocation[71] = ' MVA Bag - Offside 2';
itemPictureLocation[71] = 'mvaBagLocation.jpg';

itemName[72] = 'Cable Ties';
itemPicture[72] = 'cableTiesYellow.jpg';
itemLocation[72] = ' MVA Bag - Offside 2';
itemPictureLocation[72] = 'mvaBagLocation.jpg';

itemName[73] = 'Side Cutters (red)';
itemPicture[73] = 'sideCutters.jpg';
itemLocation[73] = ' MVA Bag - Offside 2';
itemPictureLocation[73] = 'mvaBagLocation.jpg';

itemName[74] = 'Curved Needle Nose Pliers (red)';
itemPicture[74] = 'CurvedNeedleNosePliers.jpg';
itemLocation[74] = ' MVA Bag - Offside 2';
itemPictureLocation[74] = 'mvaBagLocation.jpg';

itemName[75] = 'Pliers (Red)';
itemPicture[75] = 'pliers.jpg';
itemLocation[75] = ' MVA Bag - Offside 2';
itemPictureLocation[75] = 'mvaBagLocation.jpg';

itemName[76] = 'Neele Nosed Pliers';
itemPicture[76] = 'needleNosedPliers.jpg';
itemLocation[76] = ' MVA Bag - Offside 2';
itemPictureLocation[76] = 'mvaBagLocation.jpg';

itemName[77] = 'Multigrips (red)';
itemPicture[77] = 'multigrips.jpg';
itemLocation[77] = ' MVA Bag - Offside 2';
itemPictureLocation[77] = 'mvaBagLocation.jpg';

itemName[78] = 'Non-Deployed Airbag Tape';
itemPicture[78] = 'airTape.jpg';
itemLocation[78] = ' MVA Bag - Offside 2';
itemPictureLocation[78] = 'mvaBagLocation.jpg';

itemName[79] = 'blank.png';
itemPicture[79] = 'blank.png';
itemLocation[79] = ' MVA Bag - Offside 2';
itemPictureLocation[79] = 'mvaBagLocation.jpg';
...
function mouseClicked() {
  ...
  if(clickNumber % 2== 0){
    ...
    if(itemNumber==61) {image(itemPicture61, 0, 100); text(itemName[61], 10 , 90);}
    if(itemNumber==62) {image(itemPicture62, 0, 100); text(itemName[62], 10 , 90);}
    if(itemNumber==63) {image(itemPicture63, 0, 100); text(itemName[63], 10 , 90);}
    if(itemNumber==64) {image(itemPicture64, 0, 100); text(itemName[64], 10 , 90);}
    if(itemNumber==65) {image(itemPicture65, 0, 100); text(itemName[65], 10 , 90);}
    if(itemNumber==66) {image(itemPicture66, 0, 100); text(itemName[66], 10 , 90);}
    if(itemNumber==67) {image(itemPicture67, 0, 100); text(itemName[67], 10 , 90);}
    if(itemNumber==68) {image(itemPicture68, 0, 100); text(itemName[68], 10 , 90);}
    if(itemNumber==69) {image(itemPicture69, 0, 100); text(itemName[69], 10 , 90);}
	
    if(itemNumber==70) {image(itemPicture70, 0, 100); text(itemName[70], 10 , 90);}
    if(itemNumber==71) {image(itemPicture71, 0, 100); text(itemName[71], 10 , 90);}
    if(itemNumber==72) {image(itemPicture72, 0, 100); text(itemName[72], 10 , 90);}
    if(itemNumber==73) {image(itemPicture73, 0, 100); text(itemName[73], 10 , 90);}
    if(itemNumber==74) {image(itemPicture74, 0, 100); text(itemName[74], 10 , 90);}
    if(itemNumber==75) {image(itemPicture75, 0, 100); text(itemName[75], 10 , 90);}
    if(itemNumber==76) {image(itemPicture76, 0, 100); text(itemName[76], 10 , 90);}
    if(itemNumber==77) {image(itemPicture77, 0, 100); text(itemName[77], 10 , 90);}
    if(itemNumber==78) {image(itemPicture78, 0, 100); text(itemName[78], 10 , 90);}
    if(itemNumber==79) {image(itemPicture79, 0, 100); text(itemName[79], 10 , 90);}
  ...
  }else
  {
	...
	if(itemNumber == 61){image(itemPictureLocation61, 0, 100); text(itemLocation[61], 10 , 90); text(itemName[61], 10 , 50);}
    if(itemNumber == 62){image(itemPictureLocation62, 0, 100); text(itemLocation[62], 10 , 90); text(itemName[62], 10 , 50);}
    if(itemNumber == 63){image(itemPictureLocation63, 0, 100); text(itemLocation[63], 10 , 90); text(itemName[63], 10 , 50);}
    if(itemNumber == 64){image(itemPictureLocation64, 0, 100); text(itemLocation[64], 10 , 90); text(itemName[64], 10 , 50);}
    if(itemNumber == 65){image(itemPictureLocation65, 0, 100); text(itemLocation[65], 10 , 90); text(itemName[65], 10 , 50);}
    if(itemNumber == 66){image(itemPictureLocation66, 0, 100); text(itemLocation[66], 10 , 90); text(itemName[66], 10 , 50);}
    if(itemNumber == 67){image(itemPictureLocation67, 0, 100); text(itemLocation[67], 10 , 90); text(itemName[67], 10 , 50);}
    if(itemNumber == 68){image(itemPictureLocation68, 0, 100); text(itemLocation[68], 10 , 90); text(itemName[68], 10 , 50);}
    if(itemNumber == 69){image(itemPictureLocation69, 0, 100); text(itemLocation[69], 10 , 90); text(itemName[69], 10 , 50);}
	
    if(itemNumber == 70){image(itemPictureLocation70, 0, 100); text(itemLocation[70], 10 , 90); text(itemName[70], 10 , 50);}
	if(itemNumber == 71){image(itemPictureLocation71, 0, 100); text(itemLocation[71], 10 , 90); text(itemName[71], 10 , 50);}
    if(itemNumber == 72){image(itemPictureLocation72, 0, 100); text(itemLocation[72], 10 , 90); text(itemName[72], 10 , 50);}
    if(itemNumber == 73){image(itemPictureLocation73, 0, 100); text(itemLocation[73], 10 , 90); text(itemName[73], 10 , 50);}
    if(itemNumber == 74){image(itemPictureLocation74, 0, 100); text(itemLocation[74], 10 , 90); text(itemName[74], 10 , 50);}
    if(itemNumber == 75){image(itemPictureLocation75, 0, 100); text(itemLocation[75], 10 , 90); text(itemName[75], 10 , 50);}
    if(itemNumber == 76){image(itemPictureLocation76, 0, 100); text(itemLocation[76], 10 , 90); text(itemName[76], 10 , 50);}
    if(itemNumber == 77){image(itemPictureLocation77, 0, 100); text(itemLocation[77], 10 , 90); text(itemName[77], 10 , 50);}
    if(itemNumber == 78){image(itemPictureLocation78, 0, 100); text(itemLocation[78], 10 , 90); text(itemName[78], 10 , 50);}
    if(itemNumber == 79){image(itemPictureLocation79, 0, 100); text(itemLocation[79], 10 , 90); text(itemName[79], 10 , 50);}
...
function preLoadAllImages() {
  ...
  itemPictureLocation61 = loadImage(itemPictureLocation[61]);
  itemPictureLocation62 = loadImage(itemPictureLocation[62]);
  itemPictureLocation63 = loadImage(itemPictureLocation[63]);
  itemPictureLocation65 = loadImage(itemPictureLocation[65]);
  itemPictureLocation64 = loadImage(itemPictureLocation[64]);
  itemPictureLocation66 = loadImage(itemPictureLocation[66]);
  itemPictureLocation67 = loadImage(itemPictureLocation[67]);
  itemPictureLocation68 = loadImage(itemPictureLocation[68]);
  itemPictureLocation69 = loadImage(itemPictureLocation[69]);
  
  itemPictureLocation70 = loadImage(itemPictureLocation[70]);
  itemPictureLocation71 = loadImage(itemPictureLocation[71]);
  itemPictureLocation72 = loadImage(itemPictureLocation[72]);
  itemPictureLocation73 = loadImage(itemPictureLocation[73]);
  itemPictureLocation75 = loadImage(itemPictureLocation[75]);
  itemPictureLocation74 = loadImage(itemPictureLocation[74]);
  itemPictureLocation76 = loadImage(itemPictureLocation[76]);
  itemPictureLocation77 = loadImage(itemPictureLocation[77]);
  itemPictureLocation78 = loadImage(itemPictureLocation[78]);
  itemPictureLocation79 = loadImage(itemPictureLocation[79])
  ...
  itemPicture61 = loadImage(itemPicture[61]);
  itemPicture62 = loadImage(itemPicture[62]);
  itemPicture63 = loadImage(itemPicture[63]);
  itemPicture64 = loadImage(itemPicture[64]);
  itemPicture65 = loadImage(itemPicture[65]);
  itemPicture66 = loadImage(itemPicture[66]);
  itemPicture67 = loadImage(itemPicture[67]);
  itemPicture68 = loadImage(itemPicture[68]);
  itemPicture69 = loadImage(itemPicture[69]);
  
  itemPicture70 = loadImage(itemPicture[70]);
  itemPicture71 = loadImage(itemPicture[71]);
  itemPicture72 = loadImage(itemPicture[72]);
  itemPicture73 = loadImage(itemPicture[73]);
  itemPicture74 = loadImage(itemPicture[74]);
  itemPicture75 = loadImage(itemPicture[75]);
  itemPicture76 = loadImage(itemPicture[76]);
  itemPicture77 = loadImage(itemPicture[77]);
  itemPicture78 = loadImage(itemPicture[78]);
  itemPicture79 = loadImage(itemPicture[79]);
